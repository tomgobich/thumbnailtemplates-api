...
app.get('/thumbnail/id/:id',                              ThumbnailRouter.getThumbnailById)
app.get('/thumbnail/alias/:alias',                        ThumbnailRouter.getThumbnailByAlias)
app.get('/thumbnail/images/:id',                          ThumbnailRouter.getThumbnailImagesById)
